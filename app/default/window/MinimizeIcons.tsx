	...
	return (
		...
		>
			...
			<g filter="url(#minimize_active_filter0)">
				<rect
					fill="url(#minimize_active_paint0)"
					height="19"
					rx="2"
					width="19"
					x="2"
			...
			<g filter="url(#minimize_active_filter1)">
				<rect
					fill="url(#minimize_active_paint2)"
					height="15"
					width="1"
					x="4"
					y="4"
				/>
				<rect
					fill="url(#minimize_active_paint3)"
					height="15"
		...
		>
			...
			<g opacity="0.6">
				<g filter="url(#minimize_inactive_filter0)">
					<rect
						fill="url(#minimize_inactive_paint0)"
						height="19"
						rx="2"
						width="19"
						x="2"
				...
				<g filter="url(#minimize_inactive_filter1)">
					<rect
						fill="url(#minimize_inactive_paint2)"
						height="15"
						width="1"
						x="4"
						y="4"
					/>
					<rect
						fill="url(#minimize_inactive_paint3)"
						height="15"
						transform="rotate(-90 4 5)"
						width="1"
						x="4"
	...
	return (
		...
		>
			...
			<g filter="url(#minimize_hover_filter0)">
				<rect
					fill="url(#minimize_hover_paint0)"
					height="19"
					rx="2"
					width="19"
					x="2"
			...
			<g filter="url(#minimize_hover_filter1)">
				<rect
					fill="url(#minimize_hover_paint2)"
					height="15"
					width="1"
					x="4"
					y="4"
				/>
				<rect
					fill="url(#minimize_hover_paint3)"
					height="15"
					transform="rotate(-90 4 5)"
					width="1"
					x="4"
	...
	return (
		...
		>
			...
			<g filter="url(#minimize_clicked_filter0)">
				<rect
					fill="url(#minimize_clicked_paint0)"
					height="19"
					rx="2"
					width="19"
					x="2"
			...
			<g filter="url(#minimize_clicked_filter1)" opacity="0.33">
				<rect
					fill="url(#minimize_clicked_paint1)"
					height="15"
					width="1"
					x="4"
					y="4"
				/>
				<rect
					fill="url(#minimize_clicked_paint2)"
					height="15"
					transform="rotate(-90 4 5)"
					width="1"
					x="4"
		...
		>
			...
			<g opacity="0.5">
				<g filter="url(#minimize_disabled_filter0)">
					<rect
						fill="url(#minimize_disabled_paint0)"
						height="19"
						rx="2"
						width="19"
						x="2"
				...
				<g filter="url(#minimize_disabled_filter1)">
					<rect
						fill="url(#minimize_disabled_paint2)"
						height="15"
						width="1"
						x="4"
						y="4"
					/>
					<rect
						fill="url(#minimize_disabled_paint3)"
						height="15"
						transform="rotate(-90 4 5)"
						width="1"
						x="4"
