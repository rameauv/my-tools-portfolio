...
type ModuleCallback = (module?: unknown) => void;
...
declare namespace Vips {
	...
	abstract class EmbindClassHandle<T extends EmbindClassHandle<T>> {
		 ...
		 */
		// @ts-expect-error - If targeting lower than ESNext, this symbol might not exist.
		[Symbol.dispose](): void;
	...
	// biome-ignore lint/complexity/noStaticOnlyClass: That's how the lib is made
	...
	class Image extends ImageAutoGen {
		 ...
		 */
		writeToFile(vipsFilename: string, options?: Record<string, unknown>): void;
		 ...
		 * @param options Optional options that depend on the save operation.
		 */
		writeToTarget(target: Target, formatString: string, options?: Record<string, unknown>): void;
